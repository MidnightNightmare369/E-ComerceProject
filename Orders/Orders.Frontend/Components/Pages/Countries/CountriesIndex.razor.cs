...
public partial class CountriesIndex
{
    ...
    [Inject] private IDialogService DialogService { get; set; } = null!; //Para poder llamar el componente confirm como un dialog
    [Inject] private ISnackbar Snackbar { get; set; } = null!;//Lo usamos para pintar mensajes toast
    [Inject] private NavigationManager NavigationManager { get; set; } = null!;//Para movernos entre paginas
