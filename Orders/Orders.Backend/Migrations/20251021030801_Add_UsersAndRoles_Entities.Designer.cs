...
namespace Orders.Backend.Migrations
{
    ...
    [Migration("20251021030801_Add_UsersAndRoles_Entities")]
    partial class Add_UsersAndRoles_Entities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orders.Share.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Orders.Share.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Orders.Share.Entities.User", b =>
                {
                    b.HasOne("Orders.Share.Entities.City", "City")
                        .WithMany("Users")
